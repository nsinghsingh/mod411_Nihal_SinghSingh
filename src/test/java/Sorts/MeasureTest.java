...
import Sorts.AB411_06_InsertionSort;
import Sorts.AB411_08_QuickSort;
import Sorts.Measure;
...
class MeasureTest {
    ...
    void measure() {
        ...
        //liste = Sorts.Structures.makeArray(100000);
        //Sorts.AB411_07_BubbleSort<Integer> integerSort2 = new Sorts.AB411_07_BubbleSort<>();
        //long duration2 = Sorts.Measure.measure(liste, integerSort2::sort);
